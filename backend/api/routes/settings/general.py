...
async def test_post_action_webhook(
    ...
    result = await send_post_action_webhook(
        ...
        PostActionWebhookEvent(
            ...
            title="MediaMasterr Test Movie",
            tmdb_id=550,
            candidate_id=0,
            path="/media/movies/MediaMasterr Test Movie (1999)/movie.mkv",
            local_path="/mnt/media/movies/MediaMasterr Test Movie (1999)/movie.mkv",
            service_type="plex",
            movie_version_id=0,
        ),
    )
